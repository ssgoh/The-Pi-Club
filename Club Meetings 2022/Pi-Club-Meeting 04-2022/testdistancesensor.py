...
while True:
    ...
    #we get the time as soon as the ECHO pin == 1, which is when the trigger pin sends out the pulse
   ...
   #the Echo pin remains high until the pusle echo is received back
    ...
    while GPIO.input(ECHO)==1:
        pulse_end=time.time()
    #we get the time as soon as the ECHO pin == 0, when the signal comes back
