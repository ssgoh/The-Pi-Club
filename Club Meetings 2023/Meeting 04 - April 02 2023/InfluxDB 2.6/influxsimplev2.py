...
org_name='Pico'
url = 'http://192.168.10.131:8086/write?db=weather&org=org_name'   
api_key="kOrhIPuRZf33DwdIvx4PlU2BQj2MZ_hzWYeNzEeMQYB2JSvEl70G8EFmXLm3xsvatoWjoE0B9rzEVVhsI7Dszg=="
headers = {
"Content-Type": "application/octet-stream",
"Authorization": f"Token {api_key}",
"InfluxDB-Org": org_name
}
